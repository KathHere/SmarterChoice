							...
							<tbody>
								...
								<tr class="active">
									...
									<td class="visible-lg" style="text-align:center;">
											<button type="button" class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#edit_user<?php echo $user->userID ?>"><i class="glyphicon glyphicon-pencil"></i> Edit</button>
											<a href="javascript:void(0)" class="delete-users" data-id="<?php echo $user->userID ?>"><button type="button" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Delete</button></a>
									</td>
								</tr>
        				...
        				<div class="col-md-6">
										 ...
										 <!--  <div class="form-group">
										  ...
										  <div class="form-group">
											...
											<?php else :?>
													<input type="text" name="group_name" class="form-control" id="" placeholder="This is for hospice users only" value="<?php echo $user->hospice_name ?>" readonly> 
