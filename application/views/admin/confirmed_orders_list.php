				...
				<div class="inner-form-container page-shadow OpenSans-Reg" style="margin-top: 140px;;min-height: 650px;height:auto;padding: 28px;background-position: 37% 101.4%;">
					...
					<div class="row">
						...
						<div class="">
							...
							<h2 class="OpenSans-Reg" style="margin-top: -26px;text-align:center;margin-bottom: 40px;">Patient Records</h2>

						<table id="confirmed_table" class="table table-hover">
							...
							<thead>
								...
								<tr>
									...
									<th class="visible-lg"><h5>Added By</h5></th>
									 ...
									 <!--th class="visible-lg"><h5>Date Added</h5></th-->
							...
							<tbody>
								...
								<?php foreach ($orders as $order) :?>
									...
									<tr class="active" >
										...
										<td class="visible-lg" ><?php echo $order['medical_record_id'] ?></td>
										...
										<td class="visible-lg" style="text-align:center;">
												...
												<a href="javascript:void(0)" class="delete-confirmed-orders" data-id="<?php echo $order['uniqueID'] ?>"><button class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Delete</button></a>
