...
<div class="row print-frame-div">
    ...
    <iframe id="printf" name="printf" src="<?php echo base_url(); ?>inventory/purchase_order_requisition_details_v2/<?php echo $purchase_order_no; ?>/<?php echo $order_req_id; ?>" style="visibility: hidden !important; height: 0px !important"></iframe>
