                ...
                ?>
                        <tr data-id="Sample data-id" style="<?php if($summary['parentID'] != 0) echo 'display:none' ?>">
                          ...
                          <td style="width:auto">
                                      ...
                                      if($subequipment_id)
                                      {
                                        ...
                                        foreach ($subequipment_id as $key) 
                                        {
                                          ...
                                          if($value)
                                          {
                                            ...
                                            {
                            ?>
                                              <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-differ="<?php echo $summary['orderID']; ?>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo "Full Electric ".$summary['key_desc']." ".$key['key_desc'].""; ?></a></strong>
                            <?php           
                                            } 
                            ...
                            <?php           }else if($summary['equipmentID'] == 49 || $summary['equipmentID'] == 71) { ?>
                            ...
                            <?php             
                                              if($key['equipmentID'] == 92 || $key['equipmentID'] == 124)
                                              {
                                                $key['key_desc'] = '16" Narrow';
                                              } else if($key['equipmentID'] == 93 || $key['equipmentID'] == 125) {
                            ...
                            <?php          
                                              ...
                                              <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc'] ?></a></strong>
                            <?php           }
                                      } else if($summary['equipmentID'] == 4 || $summary['equipmentID'] == 149 || $summary['equipmentID'] == 174 || $summary['equipmentID'] == 176) { ?>
                                        <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc'] ?></a></strong>
                            <?php     }
                                    }
                                  } else { ?>
                                        ...
                                        foreach ($subequipment_id as $key) {
                                          ...
                                          if($value)
                                          {
                                            ...
                                            //equipment full electric hospital bed
                                             ...
                                             {
                            ?>
                                              <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>"><?php echo "Full Electric ".$summary['key_desc']." ".$key['key_desc'].""; ?></a></strong>
                                        <?php           
                                            } 
                          ...
                          <?php 
                            ...
                            if($summary['categoryID']!=3) //cappped=1, noncapped=2
                            {
                              ...
                              if($summary['categoryID']==2)
                              {
                                ...
                                {
                                  if($summary['equipmentID'] == 4 || $summary['equipmentID'] == 9)
                                  {
                                    $quantity = $summary['equipment_value'];
                                  } else {
