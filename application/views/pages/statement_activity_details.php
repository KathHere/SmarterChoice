...
<div class="row header_container">
	...
	<div class="col-md-6 account_statement_header">
		<div class="row hidden-header" style="text-align: center; margin-bottom: 20px; font-size: 30px; font-weight: bold;display: none;">INVOICE</div>
	</div>
</div>
	...
	<div style="display: flex;">
		<div class="d-flex-address" style="padding-right: 20px; width: 60%">
			<table class="table bg-white b-a" style="text-transform: uppercase !important;">
				<tr>
					<td class="with-border td-info-box td-info-box td-info-header"><strong>Shipping Address</strong></td>
				</tr>
				<tr>
					<td class="with-border td-info-box td-address-box">
			...
			<table class="table bg-white b-a" style="text-transform: uppercase !important;">
				<tr>
					<td class="with-border td-info-box td-info-box td-info-header"><strong>Billing Address</strong></td>
				</tr>
				<tr>
					<td class="with-border td-info-box td-address-box">
						<!-- COMPASSIONCARE HOSPICE </br>
			...
			<table class="table bg-white b-a" style="text-transform: uppercase !important;">
				<tr>
					<td class="with-border td-info-box td-info-box td-info-header"><strong>Send all Payments to</strong></td>
				</tr>
				<tr>
					<td class="with-border td-info-box td-address-box">
...
<input type="hidden" id="statement_invoice_id" value="<?php echo $invoice_details[0]['acct_statement_invoice_id']; ?>">
<div><div class="show-print" style="float: left; margin-top: -12px; display: none"><i class="fa fa-scissors" style="font-size: 25px"></i></div><hr id="dashed_lines" style="border-bottom: 1px dashed #edf1f2" /></div>
<div class="wrapper-md" id="order_list" style="">
		...
		<tbody id="order_list_tbody">
			...
			<tr style="background-color: #efefef">
				...
				<td class="with-border">
					<div class="customer_name_container" style="font-size: 15px"><strong><?php echo $customer_order['p_lname'].', '.$customer_order['p_fname'] ?> - MR# <?php echo $customer_order['medical_record_id']; ?></strong></div>
				</td>
