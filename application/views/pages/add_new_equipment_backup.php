                          ...
                          <div class="panel panel-default ng-scope">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  ...
                                  <div class="col-sm-12" style="margin-left: -13px">
                                    <div class="form-group" style="" id="fordelivery_categories2">
                                      ...
                                      <select  name="delivery_address" class="form-control m-b" id="select_pickup_address" tabindex="9" style="margin-left:5px"> 
                                        <?php 
                                          if($old_address){
                                        ?>
                                            <optgroup label="Original Address">
                                ...
                                <div class="col-sm-12 address_equipment_col" id="pickup_div_<?php echo $old_address['id']; ?>">
                                        ...
                                        <div class="col-md-6" style="float:right;">
                                          ...
                                          <?php 
                                            foreach ($equip_orders as $sub_key=>$sub_value): 
                                              ...
                                              $cont =  array($sub_value[0]['p_street'],$sub_value[0]['p_placenum'],$sub_value[0]['p_city'],$sub_value[0]['p_state'],$sub_value[0]['p_postalcode']);

                                              if($sub_value[0]['original_activity_typeid']==4 || $sub_value[0]['activity_typeid']==4)
                                              {
                                                $ptmove_details = get_ptmove_address($sub_value[0]['medical_record_id'], $sub_value[0]['uniqueID']);
                                                $cont = array(
                                                          $ptmove_details['ptmove_street'],
                                                          $ptmove_details['ptmove_placenum'],
                                                          $ptmove_details['ptmove_city'],
                                                          $ptmove_details['ptmove_state'],
                                                          $ptmove_details['ptmove_postal']
                                                        );
                                              }
                                          ?>
                                ...
                                <div> 
                                  <input type="hidden" class="pickup-counter" value="<?php echo $count; ?>"></input> 
                                </div>
                                ...
                                ****************************************************************/
                                ?>
                                <div> 
                                  <input type="hidden" class="new-pickup-counter" value="<?php echo $new_count; ?>"></input> 
                                </div>
                              ...
                              <div class="col-sm-12" style="margin-left:-12px; margin-top:45px; padding-right:0px;">
                              ...
                              <div class="col-sm-12" style="margin-left:-16px; padding-right:0px;">
            ...
            <div class="form-group " style="display:none;" id="forexchange_categories3">
              <div class="panel panel-default ng-scope">
                  ...
                  <div class="panel-body">
                                                    ...
                                                    <?php if($sub_value[0]['canceled_order'] != 1 && $sub_value[0]['pickedup_respite_order'] != 1 && $sub_value[0]['canceled_from_confirming'] != 1) :?>
                                                          <div class="checkbox" style="<?php echo $displayer; ?>" >
                                                              ...
                                                              <a class="text-danger" 
                                                                 ...
                                                                 data-container="body"
                                                                 data-content="<?php echo combine_name($cont,','); ?>"
                                                                href="#"><i class="fa fa-map-marker"></i></a>
                                                              <ul>
                                                                  <?php 
                    ...
                    <div> <input type="hidden" class="exchange-counter" value="<?php echo $count; ?>"></input> </div>
