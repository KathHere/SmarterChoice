	...
	<div class="wrapper-md">
	    ...
	    <div class="panel-report panel panel-default">
		    <div class="panel-heading">
		    	<?php
		      		if($activity_status_name == "AssistedLiving")
		      		{
		      			echo "Assisted Living";
		      		}
		      		else if($activity_status_name == "GroupHome")
		      		{
		      			echo "Group Home";
		      		}
		      		else if($activity_status_name == "HicHome")
		      		{
		      			echo "Hic Home";
		      		}
		      		else if($activity_status_name == "HomeCare")
		      		{
		      			echo "Home Care";
		      		}
		      		else
		      		{
		      			echo "Skilled Nursing Facility";
		      		}
		      	?>
		      	Residence Status
		    </div>
		    <div class="panel-body">
				...
				<div class="col-xs-12 col-sm-12 col-md-12" style="margin-top:8px;">
					...
					<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-6" style="text-align:center;">
			            ...
			            ?>
								<select class="form-control pull-center filter_residence_status_details select2-ready" name="filter_residence_status_details" style="margin-top: 6px;border: 0px;font-size: 16px;font-weight: 600;text-align-last:center;">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// var source /* arr2 */ = [{name : "childs", value: '5'}, {name: "langs", value: "German"}];
			...
			var residence_content = function(page){
				...
				if(filter_from_residence != 0)
				{
					...
					$.post(base_url+"report/sort_residence_status_details/" + filter_from_residence +"/"+ filter_to_residence +"/"+ hospiceID +"/"+ status_name+"/"+page,"", function(response){
						...
						{
							temp_html += '<tr>'+
																		'<td> <a class="" href="'+base_url+'order/patient_profile/'+obj.patient_list[val].medical_record_id+'/'+obj.patient_list[val].organization_id+'" target="_blank"> '+obj.patient_list[val].p_lname+', '+obj.patient_list[val].p_fname+' </a></td>'+
		...
		$('select.filter_residence_status_details').on('change', function (e)
	  	...
	  	$('body').on('click','.print_residence_status',function(){
          	...
          	window.open(base_url+'report/print_residence_status_details_v2/'+filter_from_residence+'/'+filter_to_residence+'/'+hospiceID+'/'+status_name);
	  	});
