                ...
                ?>
                        <tr data-id="Sample data-id" style="<?php if($summary['parentID'] != 0) echo 'display:none' ?>">
                          ...
                          <td style="width:auto">
                            ...
                            ?>
                                      <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" data-differ="<?php echo $summary['orderID']; ?>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo "Full Electric ".$summary['key_desc']; ?></a></strong>
                            <?php 
                                    }else{
                            ?>
                            ...
                            <?php 
                                ...
                                if($summary['equipmentID'] == 55 || $summary['equipmentID'] == 20){
                            ?>
                                  <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>"><?php echo "Full Electric ".$summary['key_desc']; ?></a></strong>
                            <?php 
                                }else{
                            ?>
