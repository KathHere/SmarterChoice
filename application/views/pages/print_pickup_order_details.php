...
<?php
  if(!empty($informations)) :
    ...
    $queried_data = get_patients_first_order_uniqueID($info['medical_record_id'],$info['organization_id']);
    if($queried_data['uniqueID'] == $info['uniqueID'])
    {
      $returned_result = check_if_new_patient($info['medical_record_id'],$queried_data['uniqueID'],$info['organization_id']);
    }
    else
    {
