...
<?php
  if(!empty($informations)) :
    ...
    $patientID = get_patientID($info['medical_record_id'],$hospiceID);
...
?>
    ...
    ?>
    <!-- <div class="wrapper-md" style="padding-top: 0px; padding-bottom: 0px">
    ...
    <div class="bg-light lter b-b wrapper-md work_order_header_container">
      ...
      <?php
        ...
        $location = get_login_location($info['account_location']);
      ?>
        ...
        <tbody style="border-top:1px solid;border-top-color:rgba(0, 0, 0, 0.50);">
          ...
          <tr>
            <td class="td_content last_row_order_info_table" colspan="2">
              <?php
                $liter_flow = get_liter_flow($hospiceID,$info['medical_record_id']);
                ...
                if($liter_flow['parentID'] != 61 || $liter_flow['parentID'] != 29 || $liter_flow['parentID'] != 36)
                {
                  ...
                  $parentID = get_parent_id($hospiceID,$info['medical_record_id']);
                  $liter_flow['parentID'] = $parentID['parentID'];
                  $liter_flow['uniqueID'] = $parentID['uniqueID'];
                }
                $parentID_duration = get_parent_id_duration($hospiceID,$info['medical_record_id']);
                ...
                //get BIPAP SETTINGS
                $IPAP = get_ipap($hospiceID,$info['medical_record_id']);
                $EPAP = get_epap($hospiceID,$info['medical_record_id']);
                $rate = get_rate($hospiceID,$info['medical_record_id']);

                //get CIPAP SETTINGS
                $CIPAP = get_cipap($hospiceID,$info['medical_record_id']);
              ?>
              ...
              <?php
                      if(!empty($duration_)){
                        ...
                        $latest_delivery_device = get_latest_delivery_device($hospiceID,$info['medical_record_id']);
            ...
            <td class="td_content last_row_order_info_table">
              <?php
              $response = get_items_for_pickup($info['medical_record_id'],$hospiceID);
              ...
              foreach ($patient_addresses as $key=>$value) {
                $new_response_query = get_items_for_pickup_other_address($info['medical_record_id'],$hospiceID,$value['id']);
        ...
        <tbody style="border-top:1px solid;border-top-color:rgba(0, 0, 0, 0.50);">
          ...
          ?>
                  <tr>
                    ...
                    <td class="td_ordered_items" style="text-transform:uppercase !important;">
                      <?php
