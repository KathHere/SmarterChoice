...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Patient Profile</h1>
</div>
     ...
     <div class="well m-t bg-light lt">
      <div class="row">
        ...
        <?php //get 02 Liter Flow
          ...
          $duration_cnt = get_duration_cnt($information['organization_id'],$information['medical_record_id']);
          $duration_prn = get_duration_prn($information['organization_id'],$information['medical_record_id']);
          $duration_ = "";
          ...
          if(!empty($liter_flow) || !empty($IPAP) || !empty($EPAP) || !empty($rate) || !empty($CIPAP) || !empty($O2LR))
          {
        ?>
        <strong>Rx</strong>
        <p>
...
<div class="col-sm-12" style="margin-bottom:15px;">
  <div class="pull-right">
    <a class="btn btn-danger btn-xs pull-right additional_equip_button" data-toggle="popover" 
      href="<?php echo base_url('order/new_equipment/'.$information['medical_record_id']."/".$information['organization_id']) ?>" data-value=""  
...
<div class="pull-right">
  ...
  ?>
    ...
    <?php 
                    ...
                    $pop_over_content_f1 = "<a href='".base_url("order/patient_order_list")."/".$patientID."' target='_blank'> Patient Order Status</a></span>";
                        ...
                        <a href="<?php echo base_url("order/patient_order_list")."/".$patientID ?>" target="_blank">
                          <?php 
                            ...
                            if(($label[$key+1]) == "Delivery")
                            {
                              ...
                              { 
                                $ptmove_addresses_ID = get_ptmove_addresses_ID($act[0]['patientID']);
                                foreach($ptmove_addresses_ID as $key => $addresses_ID_row) {
                              ...
                              {
                                $respite_addresses_ID = get_respite_addresses_ID($act[0]['patientID']);
                                foreach($respite_addresses_ID as $key => $addresses_ID_row) {
                                  if($addresses_ID_row['id'] == $act[0]['addressID'])
                                  {
                                    $address_sequence = $address_count;
...
<div class="col-sm-12">
    <a class="btn btn-success btn-xs pull-right activity_type_section_btn" data-toggle="popover" style="margin-bottom: 29px;margin-right: 1px;color:#fff;margin-top:-5px;display:none">
        <span class="font-bold data_tooltip"> Reactivate Patient</span>
    </a>
</div>
<?php endif;?>
    ...
    <div class="row">
      <div class="panel panel-default">
        ...
        <?php //if(!empty($summaries)) { ?>
                        ...
                        <tr data-id="Sample data-id" style="<?php if($summary['parentID'] != 0) echo 'display:none' ?>">
                          ...
                          <td style="width:90px;">
                            ...
                            <?php 
                                ...
                                // pt move and exchange need to be an original activity
                                // type
                          ...
                          <?php  /*<a href="javascript:;"
                                  id="uniqueID"
                                  data-pk="<?php echo $summary['uniqueID'] ?>" 
                                  data-url="<?php echo base_url('order/update_data/workorder/uniqueID/1'); ?>" 
                                  data-title="Enter WO#"
                                  data-value="<?php echo substr($summary['uniqueID'],4,10); ?>"
                                  data-type="number" 
                                 class="data_tooltip editable <?php echo $enableclick; ?> editable-text" 
                          ...
                          <?php 
                            ...
                            $address_type = get_address_type($summary['addressID']);
                            $address_sequence = 0;
                            $address_count = 1;
                            if($summary['activity_name'] == "Delivery")
                            {
                              ...
                              { 
                                $ptmove_addresses_ID = get_ptmove_addresses_ID($summary['patientID']);
                                foreach($ptmove_addresses_ID as $key => $addresses_ID_row) {
                                  if($addresses_ID_row['id'] == $summary['addressID'])
                                  {
                                    $address_sequence = $address_count;
                                    break;
                                  }
                              ...
                              {
                                $respite_addresses_ID = get_respite_addresses_ID($summary['patientID']);
                                foreach($respite_addresses_ID as $key => $addresses_ID_row) {
                                  if($addresses_ID_row['id'] == $summary['addressID'])
                                  {
                                    $address_sequence = $address_count;
                            ...
                            else if($summary['activity_name'] == "PT Move")
                            {
                              $ptmove_addresses_ID = get_ptmove_addresses_ID($summary['patientID']);
                              foreach($ptmove_addresses_ID as $key => $addresses_ID_row) {
                                if($addresses_ID_row['id'] == $summary['addressID'])
                          ...
                          ?>
                          <!--ACTIVITY TYPE-->
                          <td class="activity_type_column"><?php echo $activity_type_display; ?></td>
                          <!--ITEM #-->
                          ...
                          <td style="width:auto">
                            <?php 
                              if($this->session->userdata('account_type') == 'dme_admin') :
                                if($summary['equipmentID'] == 61 || $summary['equipmentID'] == 29) :
                                  $value_id = $summary['orderID'] + 2;
                                  $result = get_value_equipment($value_id);
                                  if($result['equipment_value'] == 5) { 
                            ?>
                                    <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-differ="<?php echo $summary['orderID']; ?>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">5L <?php echo $summary['key_desc'] ?></a></strong>
                            <?php 
                                  }else if($result['equipment_value'] == 10){ 
                            ?>
                                    <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-differ="<?php echo $summary['orderID']; ?>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">10L <?php echo $summary['key_desc'] ?></a></strong>
                            <?php 
                                  } else { 
                                      ...
                                      if($subequipment_id)
                                      {
                                        ...
                                        foreach ($subequipment_id as $key) 
                                        {
                                          ...
                                          if($value)
                                          {
                                            ...
                                            {
                            ?>
                                              <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-differ="<?php echo $summary['orderID']; ?>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo "Full Electric ".$summary['key_desc']." With ".$key['key_desc'].""; ?></a></strong>
                            <?php           
                                            } 
                                            else if($summary['equipmentID'] == 54 || $summary['equipmentID'] == 17)
                                            { ?>
                            ...
                            <?php           }
                                            else if($summary['equipmentID'] == 49 || $summary['equipmentID'] == 71) 
                                            { ?>
                            ...
                            <?php             echo $key['key_desc']." ".$summary['key_desc'];
                                              } else {
                            ...
                            <?php           }
                                      } else if($summary['equipmentID'] == 149 || $summary['equipmentID'] == 174 || $summary['equipmentID'] == 176) { ?>
                                        <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc'] ?></a></strong>
                            <?php     }
                                    }
                             } else { ?>
                            ...
                            <?php           
                                            ...
                                            else if($summary['equipmentID'] == 19)
                                            {
                            ?>              
                                              <strong><a href="javascript:void(0)" class="edit_item_options show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc']." With ".$key['key_desc'].""; ?></a></strong>      
                            <?php           }
                                            else if($summary['equipmentID'] == 54 || $summary['equipmentID'] == 17 || $summary['equipmentID'] == 66 || $summary['equipmentID'] == 39)
                                            { ?>
                                              <strong><a href="javascript:void(0)" class="edit_item_options show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc']." ".$key['key_desc'].""; ?></a></strong>
                            <?php           }else if($summary['equipmentID'] == 49 || $summary['equipmentID'] == 71 || $summary['equipmentID'] == 269 || $summary['equipmentID'] == 64) { ?>
                                             
                            <?php             //wheelchair & wheelchair reclining
                                              if($count == 1)
                                              { ?>
                                              <strong><a href="javascript:void(0)" class="edit_item_options show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                            <?php             
                                            ...
                                            else if($summary['equipmentID'] == 306 || $summary['equipmentID'] == 309 || $summary['equipmentID'] == 313 || $summary['equipmentID'] == 40 || $summary['equipmentID'] == 32 || $summary['equipmentID'] == 16 || $summary['equipmentID'] == 67 || $summary['equipmentID'] == 4 || $summary['equipmentID'] == 36)
                                            { 
                            ?>  
                                              <strong>
                                                <a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                            ...
                            <?php           }
                                        ...
                                        else if ($summary['equipmentID'] == 10 || $summary['equipmentID'] == 36 || $summary['equipmentID'] == 31 || $summary['equipmentID'] == 32 || $summary['equipmentID'] == 282 || $summary['equipmentID'] == 286 || $summary['equipmentID'] == 62 || $summary['equipmentID'] == 313 || $summary['equipmentID'] == 309 || $summary['equipmentID'] == 306 || $summary['equipmentID'] == 4){
                            ?>              
                                          <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc'] ?></a></strong>
                            <?php         break;
                                        ...
                                        else if($summary['equipmentID'] == 11 || $summary['equipmentID'] == 178 || $summary['equipmentID'] == 9 || $summary['equipmentID'] == 149 || $summary['equipmentID'] == 174 || $summary['equipmentID'] == 176) { ?>
                                          <strong><a href="javascript:void(0)" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" rel="popover" data-toggle="popover" data-trigger="hover" data-toggle="popover" data-html="true" data-content="<i class='fa fa-spin fa-circle-o-notch spinner-green'></i>" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc'] ?></a></strong>
                             <?php     } 
                                          //for equipments with subequipment but does not fall in $value 
                                        else if($summary['equipmentID'] == 39 || $summary['equipmentID'] == 66 || $summary['equipmentID'] == 19 || $summary['equipmentID'] == 269 || $summary['equipmentID'] == 49 || $summary['equipmentID'] == 20 || $summary['equipmentID'] == 55 || $summary['equipmentID'] == 71 || $summary['equipmentID'] == 64) { ?>        
                                        ...
                                        foreach ($subequipment_id as $key) {
                                          ...
                                          if($value)
                                          {
                                            ...
                                            //equipment full electric hospital bed
                                             ...
                                             {
                            ?>
                                              <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>"><?php echo "Full Electric ".$summary['key_desc']." With ".$key['key_desc'].""; ?></a></strong>
                                        <?php           
                                            } 
                                            //equipment geir chair
                                            else if($summary['equipmentID'] == 54 || $summary['equipmentID'] == 17)
                                            { ?>
                                              <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc']." ".$key['key_desc'].""; ?></a></strong>
                            <?php             //equipment wheelchair  
                                            }else if($summary['equipmentID'] == 49 || $summary['equipmentID'] == 71) { ?>
                                              <strong><a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover edit_item_options show_on_print" data-uniqueid="<?php echo $summary['uniqueID'] ?>" data-id="<?php echo $summary['equipmentID'] ?>" data-medical-id="<?php echo $summary['medical_record_id'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>"><?php echo $summary['key_desc']." (".$key['key_desc'].")"; ?></a></strong>
                          ...
                          <?php 
                            ...
                            if($summary['categoryID']!=3) //cappped=1, noncapped=2
                            {
                              ...
                              if($summary['categoryID']==2)
                              {
                                ...
                                {
                                  if($summary['equipmentID'] == 4 || $summary['equipmentID'] == 9 || $summary['equipmentID'] == 176)
                                  {
                                    $quantity = $summary['equipment_value'];
                                  } else {
                            ...
                            <?php 
                              ...
                              if($summary['summary_pickup_date'] != '0000-00-00' AND $summary['summary_pickup_date']!="")
                              {
                                ...
                                $work_order_no_a = "<a 
                                                      ...
                                                      data-act-id='".$summary[$get_type]."' 
                                                      data-equip-id='".$summary['equipmentID']."' 
                                                      data-patient-id='".$summary['patientID']."'
                                                      data-activity-reference-id='".$summary['activity_reference']."'
                                                      >
                                                      ".$work_order_no."
                                                      </a>
                                                      ";
          ...
          <?php }else{ ?>
            <p class="text-center"> This patient has no orders.</p>
          <?php } ?>
        </div>
      </div>
    </div>
