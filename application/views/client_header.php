		          ...
		          <div class="pull-right header-contents" style="margin-top: -10px;">
					...
					<div class="dropdown" style="margin-top: 16px;">
					  ...
					  <li role="presentation">
					  	...
					  	<li role="presentation">
							<?php $id =  $this->session->userdata('userID') ?>
							<a role="menuitem" tabindex="-1" href="<?php echo base_url('client_order/list_orders/'.get_code($id)) ?>" >Patient Order Summary</a>
						</li>
				   ...
				   <li class="sys-features" >
					<div class="dropdown" style="margin-top: 16px;">
					  ...
					  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
						...
						<!--<li role="presentation">
							<a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#edit_hosp_account<?php echo $this->session->userdata('userID') ?>">Manage Account</a>
						</li>-->
						<li role="presentation">
						...
						<li role="presentation">
							<a role="menuitem" tabindex="-1" href="<?php echo base_url('client/users') ;?>" >Manage Users</a>
						</li>
						<li role="presentation">
...
<div class="modal fade edit_account" id="edit_hosp_account<?php echo $this->session->userdata('userID') ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
