              ...
              <input type="hidden" name="count_looped_data" value="<?php echo count($summaries); ?>" />
                <?php foreach($summaries as $info) :?>
                    ...
                    <tr style="<?php if($info['canceled_order'] == 1) echo 'text-decoration:line-through' ?> <?php if($info['parentID'] != 0) echo 'visibility:hidden;position: fixed;top: 1px;left: 1px;' ?> ">
                      ...
                      <td style="width:auto">
                      <?php 
                        //item description newly added format of each equipment by marjorie 4/22/16

                        //equipment is oxygen concentrator
                        if($info['equipmentID'] == 61 || $info['equipmentID'] == 29) {
                          $value_id = $info['orderID'] + 2;
                          $result = get_value_equipment($value_id);
                          if($result['equipment_value'] == 5) { 
                            ?>
                            <a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover" data-uniqueid="<?php echo $info['uniqueID'] ?>" data-id="<?php echo $info['equipmentID'] ?>" >5L <?php echo $info['key_desc'] ?></a>
                      <?php } else if($result['equipment_value'] == 10) { ?>
                            <a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover" data-uniqueid="<?php echo $info['uniqueID'] ?>" data-id="<?php echo $info['equipmentID'] ?>" >10L <?php echo $info['key_desc'] ?></a>
                      <?php }
                        } else {
                        ...
                        ?>
                                <a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover" data-uniqueid="<?php echo $info['uniqueID'] ?>" data-id="<?php echo $info['equipmentID'] ?>" ><?php echo "Full Electric ".$info['key_desc']." With ".$key['key_desc']; ?></a>
                        <?php 
                        ...
                        <?php     if($key['equipmentID'] == 92 || $key['equipmentID'] == 124)
                                  {
                              ...
                              } else if($info['equipmentID'] == 4 || $info['equipmentID'] == 36 ){ ?>
                        ...
                        <?php 
                            ...
                            else if($info['equipmentID'] == 4 || $info['equipmentID'] == 149 || $info['equipmentID'] == 174 || $info['equipmentID'] == 176)
                            { ?>
                              <a href="javascript:void(0)" data-toggle="popover" class="equipment_options_tooltip equipment_options_hover" data-uniqueid="<?php echo $info['uniqueID'] ?>" data-id="<?php echo $info['equipmentID'] ?>" ><?php echo $info['key_desc'] ?></a>
                      <?php }
                          } //end of foreach
