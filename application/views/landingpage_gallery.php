							 ...
							 <div id="magic_carousel_white6">
					          ...
					          <!-- Mattress -->
				          	  <div id="magic_carousel_white1">
					                ...
					                <!-- CONTENT -->
					                <ul class="magic_carousel_list">
					                    <li data-title="Hydraulic Lifts" data-bottom-thumb="<?php echo base_url('assets/carousel_img/dakar-1.jpg') ;?>"  ><img src="<?php echo base_url('assets/carousel_img/dakar-8.jpg') ;?>" alt="" /></li>  
					                    <li data-title="Commode Sling" data-bottom-thumb="<?php echo base_url('assets/carousel_img/dakar-1.jpg') ;?>"  ><img src="<?php echo base_url('assets/carousel_img/dakar-9.jpg') ;?>" alt="" /></li>  
					                    <li data-title="Full Body Sling" data-bottom-thumb="<?php echo base_url('assets/carousel_img/dakar-1.jpg') ;?>"  ><img src="<?php echo base_url('assets/carousel_img/dakar-10.jpg') ;?>" alt="" /></li>  
