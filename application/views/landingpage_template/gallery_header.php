	          ...
	          <div class="pull-right header-contents" style="margin-top: -10px;"  id="single-page-nav">
					...
					<li class="sys-features" >
						...
						<div class="" style="margin-top: 16px;">
						  ...
						  <a class=" OpenSans-reg about-us-gallery" style="color:#fff;padding-right: 8px;" role="button"  href="" id="">
							About Us
						  </a>
					...
					<li class="sys-features" ><a href="" class="OpenSans-reg mission-gallery" style="padding-right: 20px;" id="">Mission</a></li>
					...
					<li class="sys-features" >
						...
						<div class="" style="margin-top: 16px;">
						  ...
						  <a id="" class=" OpenSans-reg contact-gallery" style="color:#fff;padding-right: 10px;" role="button"  href="">
							Contact Us
						  </a>
