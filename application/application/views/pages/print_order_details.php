        ...
        <div class="col-xs-6 col-sm-6">
           ...
           <?php endif;?>
            ...
            <?php 
              ...
              }else if(($info['original_activity_typeid'] == 1 || $info['activity_typeid'] == 1) || ($info['original_activity_typeid'] == 3 || $info['activity_typeid'] == 3)){
                /** Added by Russel **/
            ...
            <?php if(!empty($equipments_ordered)):?>
              <?php foreach($equipments_ordered as $equipment) :?>
                    ...
                    <?php else:?>
                      ...
                      <?php if($act_type_id == 2 && $equipment['type'] == 'Disposable Items') :?>
