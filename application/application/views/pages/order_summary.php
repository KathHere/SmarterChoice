...
<?php 
  ...
  // $patient_orders = check_if_all_pickups_v2($patient_mr,$patient_hospice_id);
  ...
  // $has_pickup   = in_multiarray(2, $patient_orders, "activity_typeid");
...
<!-- <input type="hidden" name="patient_orders_value" value="<?php print_r($patient_orders); ?>"> -->
        ...
        <tbody>
          <?php if(!empty($summaries)) :?>
            ...
            <?php foreach($summaries as $summary) :
                ...
                // echo "</pre>";
             ?>
                    <?php echo form_open("",array("id"=>"update_summary".$summary['equipmentID'])) ?>
                          <?php if($summary['canceled_order'] == 0 && $summary['canceled_from_confirming'] == 0) :?>
                            <tr data-id="Sample data-id" style="<?php if($summary['parentID'] != 0) echo 'display:none' ?>">
                              ...
                              <td style="width:auto">
                                <?php if($summary['pickup_date'] != '0000-00-00') :?>
                                  
                                  <?php if($summary['original_activity_typeid'] == 3):?>
                                    <a href="javascript:void(0)" class="data_tooltip view_original_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['uniqueID'] ?>" data-act-id="<?php echo $summary['original_activity_typeid'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                    <p class="text-success"><?php echo date("m/d/Y", strtotime($summary['pickup_date'])) ?></p></a>
                                  
                                  <?php elseif($summary['original_activity_typeid'] == 4) :?>
                                    <a href="javascript:void(0)" class="data_tooltip view_original_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['uniqueID'] ?>" data-act-id="<?php echo $summary['original_activity_typeid'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                    <p class="text-success"><?php echo date("m/d/Y", strtotime($summary['pickup_date'])) ?></p></a>
                                  
                                  <?php else:?>
                                    <a href="javascript:void(0)" class="data_tooltip view_original_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['uniqueID'] ?>" data-act-id="<?php echo $summary['activity_typeid'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                     <p class="text-success"><?php echo date("m/d/Y", strtotime($summary['pickup_date'])) ?></p></a>
                                  <?php endif;?>

                                <?php else :?>
                                  <a href="javascript:void(0)" class="data_tooltip view_original_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['uniqueID'] ?>" data-act-id="<?php echo $summary['activity_typeid'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                  <p class="text-success"></p></a>
                                <?php endif;?>
                              ...
                              <?php if($summary['categoryID'] != 3) :?>

                                <?php if($summary['categoryID'] == 2) :?>
                                  <?php if($summary['equipment_value'] > 1 || $info['equipment_value'] != ""):?>
                                      <td style="width:auto">
                                       <p><?php echo $summary['equipment_value'] ?>ea</p>
                                      </td>

                                  <?php else:?>
                                      <td style="width:auto">

                                      <?php if(get_noncapped_quantity($summary['equipmentID'],$summary['uniqueID']) == 0):?>
                                        <p>1ea</p>

                                       <?php elseif($summary['equipment_value'] == 1) :?>
                                        <p><?php echo $summary['equipment_value'] ?>ea</p>

                                      <?php else:?>
                                        <p><?php echo get_noncapped_quantity($summary['equipmentID'], $summary['uniqueID']) ?>ea</p>
                                      <?php endif;?>
                              ...
                              <?php else:?>
                              	<?php if($summary['equipment_value'] > 1) :?>
	                            <td style="width:auto">
	                                <p ><?php echo $summary['equipment_value'] ?>ea</p>
	                             </td>
	                             <?php else:?>
                								<td style="width:auto">
                									<?php if(get_disposable_quantity($summary['equipmentID'], $summary['uniqueID']) == 0) :?>
                										<p>1ea</p>
                									<?php else:?>   
                										 <p><?php echo get_disposable_quantity($summary['equipmentID'], $summary['uniqueID']) ?>ea</p>
                									<?php endif;?>
                               </td>
	                               <?php endif;?>
                          	  <?php endif;?>
                              ...
                              <td class="item_serial_number">
                                  <?php 
                                      ...
                                      {
                                        $ptmove_final = $ptmove[0];
                                        $cont = array($ptmove_final['ptmove_street'],$ptmove_final['ptmove_placenum'],$ptmove_final['ptmove_city'],$ptmove_final['ptmove_state'],$ptmove_final['ptmove_postal']);
                                      }
                                      else
                                      {
                                        $cont =  array($summary['p_street'],$summary['p_placenum'],$summary['p_city'],$summary['p_state'],$summary['p_postal']);
                                      }
                                  ?>
                                  <p  
                                      class="text-info" 
                                      rel="popover" 
                                       data-toggle="popover" 
                                       title="Equipment Address" 
                                       data-trigger="hover"
                                       data-placement="top"
                                       data-content="<?php echo combine_name($cont,','); ?>"><?php echo combine_name(array($summary['serial_num'],$summary['lot_num'])) ?>
                                  </p>
                              </td>
                              
                             <!--  <td style="width:160px !important">
                                  <input type="text" value="<?php echo $summary['lot_num'] ?>" style="float:left;width:65px !important;border:0px;" name="lot_num" class="lot_num form-control" />
                                  <i class="fa fa-comments notes_help" title="Click to View Notes." data-id="<?php echo $summary['equipmentID'] ?>" data-value="<?php echo $summary['uniqueID'] ?>" data-ename="<?php echo $summary['key_desc'] ?>" style="float:left;margin-left:4px;margin-top:10px;cursor:pointer;"></i>
                              </td> -->
                              
                               <td>
                                 <?php if($summary['summary_pickup_date'] != '0000-00-00') :?>
                                    <?php if($summary['activity_reference'] == 3) :?>
                                      <a href="javascript:void(0)" class="data_tooltip view_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['uniqueID_reference'] ?>" data-act-id="<?php echo $summary['activity_reference'] ?>" data-equip-id="<?php echo $summary['equipmentID'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                      <p class="text-danger"><?php echo date("m/d/Y", strtotime($summary['summary_pickup_date'])) ?></p>
                                    
                                    <?php elseif($summary['activity_typeid'] == 5):?>
                                      <a href="javascript:void(0)" class="data_tooltip view_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['pickedup_uniqueID'] ?>" data-act-id="<?php echo $summary['activity_reference'] ?>" data-equip-id="<?php echo $summary['equipmentID'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                      <p class="text-danger"><?php echo date("m/d/Y", strtotime($summary['summary_pickup_date'])) ?></p>

                                    <?php else:?>
                                      <a href="javascript:void(0)" class="data_tooltip view_order_information" title="Click to View Order Details" style="cursor:pointer" data-id="<?php echo $summary['medical_record_id'] ?>" data-value="<?php echo $summary['organization_id'] ?>" data-unique-id="<?php echo $summary['pickedup_uniqueID'] ?>" data-act-id="<?php echo $summary['activity_typeid'] ?>" data-equip-id="<?php echo $summary['equipmentID'] ?>" data-patient-id="<?php echo $summary['patientID'] ?>">
                                      <p class="text-danger"><?php echo date("m/d/Y", strtotime($summary['summary_pickup_date'])) ?></p>
                                      </a>
                                    <?php endif;?>
                               ...
                               <td>
                                <?php if($summary['type'] == 'Capped Item') :?>
                                  <p class="label label-info"><?php echo $summary['type'] ?></p>
                                <?php elseif($summary['type'] == 'Non-Capped Item') :?>
                                  <p class="label label-warning"><?php echo $summary['type'] ?></p>
                                <?php else :?>
                                   <p class="label label-success"><?php echo $summary['type'] ?></p>
                                <?php endif;?>
                              </td>
