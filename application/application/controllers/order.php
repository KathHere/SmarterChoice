				...
				if($post_uniqueID!="")
				{
					...
					*/
					...
					if($save_pickup_old_items)
					{
						...
						// saved automatically in PT Mover
						$save_to_confirmed_auto_data = array(
														"order_uniqueID" 	=> $pickup_old_items_uniqueid,
														"medical_record_id" => $data_post['medical_record_id'],
														"patientID" 		=> $patientID
													  );
						//echo $pickup_old_items_uniqueid;
						//saving data now
						$this->order_model->set_order_status($save_to_confirmed_auto_data);
